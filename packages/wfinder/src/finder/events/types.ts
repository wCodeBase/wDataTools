...
export type TypeMsgSearchResultItem = Pick<FileInfo, 'name'|'size'|'type'|'id'>;
...
export type TypeUiMsgData = ToMsgData<TypeMsgScan>|ToMsgData<TypeMsgSearch>|ToMsgData<TypeMsgPathManage>|ToMsgData<TypeMsgStopScan>;
export type TypeUiMsgResult = ToMsgResult<TypeMsgScan>|ToMsgResult<TypeMsgSearch>|ToMsgResult<TypeMsgPathManage>|ToMsgResult<TypeMsgStopScan>;

export interface TypeUiMsgMessage  {message: string, error?: string};
